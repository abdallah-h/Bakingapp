...
import com.abdallah.bakingapp.RecipeLoader;
import com.abdallah.bakingapp.activities.RecipeStepsActivity;
import com.abdallah.bakingapp.adapter.RecipeListAdapter;
...
public class RecipeFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Recipe>> {
    ...
    public Loader<List<Recipe>> onCreateLoader(int id, Bundle args) {
        ...
        return new RecipeLoader(getContext(), uriBuilder.toString(), sharedPreferences);
    }
    ...
    public void onLoadFinished(Loader<List<Recipe>> loader, List<Recipe> recipes) {
        ...
        mRecipe = recipes;
        RecipeListAdapter listAdapter = new RecipeListAdapter((ArrayList<Recipe>) mRecipe, context, new RecipeListAdapter.OnStepClickListener() {
            @Override
